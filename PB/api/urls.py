...
from .views import LoginView, EmployeeStatusView, EmployeeStatusUpdateView, EmployeeCreateView, EmployeeRemoveView, EmployeeSpreadsheetView, PrintEmployeeDetailsView, EnquiryCreateView, PrintEnquiryDetailsView, UpdateEnquiryStatusView
